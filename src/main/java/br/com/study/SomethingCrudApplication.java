...
public class SomethingCrudApplication {
    private static Logger logger = LoggerFactory.getLogger(SomethingCrudApplication.class);

    public static void main(String[] args) throws UnknownHostException {


        final ConfigurableApplicationContext app = SpringApplication.run(SomethingCrudApplication.class, args);
